...
export default function Portafolio() {
  ...
  <div className="slider-card">
    ...
    <div className="p-4">
      <h2 className="text-xl sm:text-2xl font-semibold text-gray-800">Pokedex</h2>
      ...
      <div className="mb-4">
        ...
        <Link
          ...
          className="mt-2 px-4 py-2 bg-blue-600 text-white font-bold rounded-md shadow-md hover:bg-blue-500 transition-colors duration-300 hover:shadow-none"
        >
          Repositorio
        </Link>
        <Link
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="mt-2 px-4 py-2 text-black font-bold rounded-md shadow-md transition-colors duration-300 hover:shadow-none"
        >
          Ver Proyecto
        </Link>
      </div>
